...
# User-scoped temp dir (cannot import heyvox.constants — used as standalone integration script).
...
# The TTS orchestrator uses a separate heyvox-media-paused-orch flag.
