...
Provides the communication channel between heyvox.main and the HUD overlay process.
...
HUDClient: runs in heyvox.main / mcp/server.py, sends messages to the HUD.
