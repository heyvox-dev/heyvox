# Requirements Archive: v1.1 Architecture Hardening
...
- [x] **HERALD-03**: osascript volume calls replaced with CoreAudio ctypes bindings
- [x] **HERALD-04**: Mute/volume detection cached (check every 5s, not every 300ms loop iteration)
...
| HERALD-03 | Phase 7 | Complete |
| HERALD-04 | Phase 7 | Complete |
